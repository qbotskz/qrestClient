...
public interface FoodRepository extends JpaRepository<Food, Integer> {
    ...
    List<Food> searchRu(@Param("name") String name, @Param("sidx") int sidx, @Param("eidx") int eidx);
    ...
    List<Food> searchKz(@Param("name") String name, @Param("sidx") int sidx, @Param("eidx") int eidx);
