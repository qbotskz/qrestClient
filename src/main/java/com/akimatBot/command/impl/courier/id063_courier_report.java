...
//
//public class id063_courier_report extends Command {
//    private User user;
...
//                    List<Order> orders = orderRepository.findOrdersByCourierAndOrderedDateBetween(user,removeTime(date),addTime(date));
//                    makeSmallReport(orders);
//                    courierReportService = new CourierReportService();
//                    courierReportService.sendCourierReport(chatId, bot , orders);
//                    return EXIT;
//                }
//                else if(isButton(187)){
...
//                    List<Order> orders = orderRepository.findOrdersByCourierAndOrderedDateBetween(userRepository.findByChatId(chatId),removeTime(start),addTime(end));
//                    courierReportService = new CourierReportService();
//                    courierReportService.sendCourierReport(chatId, bot , orders);
//                    return EXIT;
//                } else {
