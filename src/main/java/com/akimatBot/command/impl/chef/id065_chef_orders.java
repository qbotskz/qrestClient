...
//import java.util.*;
//
//public class id065_chef_orders extends Command {
//    private Order order;
...
//            case START:
//                if(isButton(191)){
//                    orders = orderRepository.findByFinishedFalseAndChefIsNullAndOperatorIsNotNullOrderByIdAsc();
//                }
//                else if(isButton(192)){
//                    orders = orderRepository.findByFinishedFalseAndChefOrderByIdAsc(userRepository.findByChatId(chatId));
//                }
...
//        List<String> ids;
//
//        list = new ArrayList<>(Arrays.asList(OrderStatus.COOKED.getName(getLanguageId())));
//        ids = new ArrayList<>(Collections.singletonList("72,"+String.valueOf(OrderStatus.COOKED.getId())+",-"));
//
//        ButtonsLeaf stat = new ButtonsLeaf(list,ids, 5, 80,chatId);
//        if(order.getChef()==null){
//            sendMessageWithKeyboard(message, 82);
//        }
//        else if(order.getChef().getChatId().equals(chatId)) sendMessageWithKeyboard(message, stat.getListButtonInline());
//        else{
//            sendMessageWithKeyboard(message, 82);
//        }
//}
